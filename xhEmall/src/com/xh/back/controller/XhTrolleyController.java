...
public class XhTrolleyController {
	...
	// 查询购物车信息
	@RequestMapping(value = "myTrolley", method = { RequestMethod.POST,
			RequestMethod.GET })
	 ...
	 * model){ List<Xhtrolley> userT=xhTrolleyService.queryTrolleyByUser(1);
	 * System.out.println(userT); model.addAttribute("userT", userT); return
	 * "/front/BuyCar.jsp"; }
	 */
	// 添加购物车
