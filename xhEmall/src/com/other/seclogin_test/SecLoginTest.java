 ...
 * under the License.
 */
package com.other.seclogin_test;

import java.io.File;
import java.io.FileOutputStream;
import java.io.IOException;
import java.util.Scanner;
import com.other.api.client.core.BASE64Decoder;
import com.other.api.client.core.login.DoLoginRequestImpl;
import com.other.api.client.core.login.DoLoginResponse;
import com.other.api.client.core.login.DoLogoutRequestImpl;
import com.other.api.client.core.login.DoLogoutResponse;
import com.other.api.client.core.login.PreLoginRequestImpl;
import com.other.api.client.core.login.PreLoginResponse;
import com.other.api.client.core.login.SendSmsRequest;
import com.other.api.client.core.login.SendSmsRequestImpl;
import com.other.api.client.core.login.SendSmsResponse;
import com.other.api.client.core.login.VerifyQuestionRequestImpl;
import com.other.api.client.core.login.VerifyQuestionResponse;
import com.other.api.client.core.login.VerifySmsRequest;
import com.other.api.client.core.login.VerifySmsRequestImpl;
import com.other.api.client.core.login.VerifySmsResponse;
import com.other.api.client.core.seclogin.SecLoginService;
...
public class SecLoginTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SecLoginService login = new SecLoginProxy("MacXing", "793e11a0211afe9d46cc1c4ebecae3c6");
    ...
    private static DoLoginResponse doLoginWithInput(SecLoginService login,
        ...
        //线下测试用户
        req.setPassword("ZhouXing1109497798");
