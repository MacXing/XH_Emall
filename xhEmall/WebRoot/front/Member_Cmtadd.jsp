		...
		<div class="m_right">
            ...
            <table border="0" style="width:880px; margin-top:20px;"  cellspacing="0" cellpadding="0">           
              ...
              <tr height="45">
                ...
                <td><input type="text" name="pid" class="add_ipt" style="width:290px;" placeholder="请给出商品..." id="checkproductbyid"/>
                	<div class="checkproduct" style="color:red;margin-top:auto"></div>
                </td>
              </tr>
              <tr height="45">
                <td align="right">服务星评 &nbsp; &nbsp;</td>
                <td><input type="text" name="commentservice" class="add_ipt" style="width:290px;" placeholder="请给出星评..."/></td>
              </tr>
              <tr height="45">
                <td align="right">物流星评 &nbsp; &nbsp;</td>
                <td><input type="text" name="commentshopping" class="add_ipt" style="width:290px;" placeholder="请给出星评..."/></td>
              </tr>
              <tr height="45">
                <td align="right">商品星评&nbsp; &nbsp;</td>
                <td><input type="text" name="commentgoods" class="add_ipt" style="width:290px;" placeholder="请给出星评..."/></td>
              </tr>
              <tr>
              	<td align="right">我要晒图...</td>            	        
                <td><input type="file" name="file" id="file"><br/>     
                	<img width="90px" height="90px" id="img" onclick="showPic()">
              	</td>
              </tr>
              <tr valign="top" height="110">
                <td align="right">评论内容 &nbsp; &nbsp;</td>
                <td style="padding-top:5px;"><textarea class="add_txt" name="commenttxt" placeholder="从这里唠吧..." id="context"></textarea></td>            	
              </tr>                 
            </table>
            <center>
            <div>
