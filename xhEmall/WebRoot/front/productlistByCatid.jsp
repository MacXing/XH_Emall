        ...
        <div class="l_list">
            ...
            <div class="list_c">           	
                	...
                	<li>
	                   ...
	                   <input type="hidden" name="pid"  id="addpid" value="${product.pid }"/>
                        ...
                        <div class="carbg">
                            ...
                            <c:if test="${current_user==null}">
                            <a href="front/Login.jsp" class="j_car" onclick="">加入购物车</a>
                            </c:if>
                        </div>
                    </li>
                </c:forEach>
                ...
                <c:if test="${pageInfo.hasPreviousPage==true }">                  
                   <a class="p_pre" href="home/queryAllProductsByCatid.action?pageNum=${pageInfo.pageNum-1}&catid=${catid}">上一页</a>
                </c:if>
                <c:if test="${pageInfo.hasPreviousPage==false }">
                	<a class="p_pre" href="home/queryAllProductsByCatid.action?pageNum=${pageInfo.pageNum}&catid=${catid}">上一页</a>
                </c:if> 
                <c:forEach items="${pageInfo.navigatepageNums }" var="n">
                	<a href="home/queryAllProductsByCatid.action?pageNum=${n}&catid=encodeURI(encodeURI(${catid}))">${n}</a>
                </c:forEach>
                <c:if test="${pageInfo.hasNextPage==true }">                  
                   <a class="p_pre" href="home/queryAllProductsByCatid.action?pageNum=${pageInfo.pageNum+1}&catid=${catid}">下一页</a>
                </c:if>
                <c:if test="${pageInfo.hasNextPage==false }">                  
                   <a class="p_pre" href="home/queryAllProductsByCatid.action?pageNum=${pageInfo.pageNum}&catid=${catid}">下一页</a>
                </c:if> 
                </div>
