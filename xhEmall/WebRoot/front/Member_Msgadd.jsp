		...
		<div class="m_right">
            ...
            <table border="0" style="width:880px; margin-top:20px;"  cellspacing="0" cellpadding="0">           
              ...
              <tr valign="top" height="110">
                ...
                <td style="padding-top:5px;"><textarea class="add_txt" name="msgtxt"></textarea></td>
              </tr>            
            </table>
            <center>
            <div>
            	<input type="button" id="btn_id" value="添加留言" class="btn_tj">
                <input type="button" value="取消" class="btn btn-white" onclick="javascript:window.location.href='${pageContext.request.contextPath }/userCenter/queryUsermessageById.action?id=${current_user.userid }'"> 
            </div>
            </center>
            </form>
        </div>
...
$("#btn_id").on("click", function(){
	...
	cache: true,
	type: "POST",		
	url:"${pageContext.request.contextPath }/userCenter/addMessage.action",
	data:formData,
    contentType: false,  
    processData: false,
	success: function(result) {
		if(result.code==100){				  	
		    alert("添加成功！");
		    window.location.href="userCenter/queryUsermessageById.action?id="+userid;
	   }else{
		  alert("添加失败！");
		  window.location.href="userCenter/queryUsermessageById.action?id="+userid;
	   } 	
