...
<div class="menu_bg">
	<div class="menu">
                  ...
                  <c:forEach items="${categoryList }" var="item">
                    ...
                    <c:set var="i" value="${i+1 }"/>
                        ...
                        <div class="zj" style="top:${-40*i}px;">
                            ...
                            <div class="zj_r">
                                <a href="#"><img src="front/images/n_img1.jpg" width="100" height="50" /></a>
                                <a href="#"><img src="front/images/n_img2.jpg" width="100" height="50" /></a>
                            </div>
                        </div>
                    </li>
                    </c:if>
        ...
        <!--End 商品分类详情 End-->                                                     
    	<ul class="menu_r">
    		<li><a href="${ pageContext.request.contextPath}/home/home.action">首页</a></li>
