		...
		<div class="m_right">
            ...
            <table border="0" style="width:880px; margin-top:20px;"  cellspacing="0" cellpadding="0">
              ...
              <tr height="45">
                ...
                <td><input type="text" name="username" value="${msg.users.username }" class="add_ipt" style="width:290px;" /></td>
              </tr>
              <tr valign="top" height="110">
                <td align="right">留言内容 &nbsp; &nbsp;</td>
                <td style="padding-top:5px;"><textarea class="add_txt" name="msgtxt">${msg.msgtxt }</textarea></td>
              </tr>            
            </table>
            <center>
            <div>
            	<input type="button" id="btn_id" value="保存修改" class="btn_tj">
                <input type="button" value="取消" class="btn btn-white" onclick="javascript:window.location.href='${pageContext.request.contextPath }/userCenter/queryUsermessageById.action?id=${msg.users.userid }'"> 
            </div>
            </center>
            </form>
        </div>
