    	...
    	<div class="two_bg">
            ...
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
             ...
             <c:forEach items="${items}" var="items">
              <tr id="ilist">
                ...
                <td align="center" style="color:#ff4e00;"><span>￥</span>${items.subTotal}</td>
                <td align="center" >${items.xhproduct.psale}<span>R</span></td>
              </tr>
              </c:forEach>
              <tr>
                <td colspan="5" align="right" style="font-family:'Microsoft YaHei';">
                    商品总价：<span style="color:#ff4e00;">￥</span><span style="color:#ff4e00;">${total}</span> ；返还积分 <span style="color:#ff4e00;" id="itotal">${total}</span><span style="color:#ff4e00;">R</span>  
                </td>
              </tr>
            </table>
            ...
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td align="center" style="font-size:14px;"><b>${express.shoppingname}</b></td>
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tr>
                <td align="right">
                	该订单完成后，您将获得 <font color="#ff4e00">${total}</font> 积分 <br />
                    商品总价: <font color="#ff4e00" id="totalfee" value="${total}"><span>￥</span>${total}</font> + 配送费用: <font color="#ff4e00" id="exfee" test=""><span>￥</span>15.00</font>
                </td>
              </tr>
              <tr height="70">
                <td align="right">
                	<b style="font-size:14px;">应付款金额：<span style="font-size:22px; color:#ff4e00;">￥</span><span style="font-size:22px; color:#ff4e00;" id="paytotal" ></span></b>
                </td>
              </tr>
              <tr height="70">
                <td align="right"><a href="front/BuyCar_Three.jsp"><img src="front/images/btn_sure.gif" /></a></td>
              </tr>
            </table>
        </div>
    </div>
