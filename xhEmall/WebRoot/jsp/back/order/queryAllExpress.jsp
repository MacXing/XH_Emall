                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody id="table_data">             
                                <c:forEach items="${expresslist }" varStatus="status" var="expresslist">
							    	<tr class="gradeX">							    		
							    		...
							    		<td>
							    			<c:if test="${expresslist.enable==1}">是</c:if>
							    			<c:if test="${expresslist.enable eq 0}">否</c:if>
							    		</td>							    			 
							    		<td class="text-center">
							    		    <a onclick="btn1(${expresslist.shoppingid })" data-toggle="modal" data-target="#myModel1" style="color:#000"><span class="glyphicon glyphicon-search"></span></a>
							    			&nbsp;&nbsp; 							    			
							    									    			
							    		    <button type="button" class="btn btn-danger btn-circle btn-outline" onclick="btn2(${expresslist.shoppingid })">	
							    			<i class="fa fa-times"></i>	
							    			</button>						 
							    			&nbsp;&nbsp;
							    			<a onclick="btn3(${expresslist.shoppingid })" style="color:#000" data-toggle="modal" data-target="#myModal2"><span class="glyphicon glyphicon-pencil"></span></a>
							    		</td> 						    									    									    		
							    	</tr>
    							</c:forEach>
                            </tbody>
  ...
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">   
        <div class="modal-content">
            ...
            <div class="modal-body">
            	<form id="add" enctype="multipart/form-data" class="form-horizontal m-t">
            					<div class="form-group">
                         			<label class="col-sm-3 control-label">快递编码：</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="shoppingcode" class="form-control" placeholder="请输入快递编码">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">快递名称：</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="shoppingname" class="form-control" placeholder="请输入快递名称">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">快递描述：</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="shoppingdesc" class="form-control" placeholder="请输入快递描述">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">支持货到付款：</label>
                                    <div class="col-sm-9">
                                        <input type="radio"name="enable"id="enable"value="1"<c:if test="${}">checked</c:if>/>是&nbsp;&nbsp;
                                    	<input type="radio"name="enable"id="enable"value="0"<c:if test="${}">checked</c:if>/>否                                        
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="addexpresstolist()">提交添加</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
  </div>
    ...
    <div class="modal-dialog">      
        <div class="modal-content">
            ...
            <div class="modal-body"> 
            	<form id="update" enctype="multipart/form-data" class="form-horizontal m-t">
            					<div class="form-group">
                         			<label class="col-sm-3 control-label">快递编号：</label>
                                    <div class="col-sm-9">
                                        <input type="hidden" name="shoppingid" id="shoppingid1" class="form-control">
                                    </div>
                                </div>
            					<div class="form-group">
                         			<label class="col-sm-3 control-label">快递编码：</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="shoppingcode" id="shoppingcode1" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">快递名称：</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="shoppingname" id="shoppingname1" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">快递描述：</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="shoppingdesc" id="shoppingdesc1" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">支持货到付款：</label>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">上传图片：</label>
                                    <div class="col-sm-4">                                   
                                    	选择图片：<img width="80px" height="100px" id="img1" onclick="showPic()">
                                        <input type="file" name="file" id="file" class="form-control">                                                                         	
                                    </div>           
                               </div>                                        
            	</form>        	
