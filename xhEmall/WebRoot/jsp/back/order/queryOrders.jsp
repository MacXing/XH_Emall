            	...
            	<form class="form-horizontal m-t" id="addorders">
            		<div class="col-md-12">                           
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="userid" id="userid11" type="text" class="form-control" placeholder="请输入会员编号">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">邮寄编号：</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="shoppingid11" name="shoppingid" class="form-control" placeholder="请输入邮寄编号">
                                    </div>
                                </div>                                                               
                                <div class="form-group">
