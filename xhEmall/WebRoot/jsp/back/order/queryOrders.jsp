            	...
            	<form class="form-horizontal m-t" id="addorders">
            		<div class="col-md-12">                           
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="userid" type="text" class="form-control checkuserbyid" placeholder="请输入会员编号">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="shoppingid" class="form-control checkexpbyid" placeholder="请输入邮寄编号">
