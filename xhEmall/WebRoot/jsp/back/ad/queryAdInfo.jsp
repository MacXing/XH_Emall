            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>广告基本信息</h5>
                        <button class="btn btn-primary" type="button"  style="margin-left: 328px;width: 100px;" >修改广告信息</button>
                         ...
                         <div class="ibox-content" style=" float: left; width:400px;">
                          ...
                          <div class="ibox-content" style="float:right; margin-top: -357px;margin-right: 1px;width: 660px;" >   
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 ">
                                 <input id="pprice" type="text" class="form-control" name="pprice" value="${oneAd.adtxt}">  
                                </div>
                            </div>
                            <br>
                             <div class="hr-line-dashed"></div>
                            ...
                            <br>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="pdesc" type="text" class="form-control" name="pdesc" value="${oneAd.adclick}"/>
