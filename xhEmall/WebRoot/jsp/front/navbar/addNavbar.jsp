                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                     <div class="radio i-checks">
		                                  <label>
		                                      <input type="radio" checked="" name="isshow" value=0> <i></i>不展示</label>
		                                  <label>
			...
			if(!confirm("您确定要增加轮播图片？")){
				...
				var formData= new FormData($("#myform")[0]);
				 ...
				 if(form==0){
					 ...
					 action="insertNavbar.action";
				} 
				$.ajax({		
					url:"${pageContext.request.contextPath }/navbar/"+action,
					   type:"POST",
					   data:formData,
				       contentType: false,  
				       processData: false,
